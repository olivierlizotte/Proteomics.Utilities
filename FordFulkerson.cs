    ...
    public class FordFulkerson
    {
        ...
        void ParseData()
        {
            ...
            foreach (var edge in edges)
            {
                ...
                double capacity = double.Parse(s[2]);
        ...
        void AugmentPath(IEnumerable<Edge> path, double minCapacity)
        {
            foreach (var edge in path)
            {
        ...
        public double GetCapacity(Node node1, Node node2)
        {
            var edge = Edges[GetKey(node1.Id, node2.Id)];
            return edge.Capacity;
        }

        public void AddEdge(Node nodeFrom, Node nodeTo, double capacity)
        {
